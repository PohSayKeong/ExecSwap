...
declare module "@nomicfoundation/hardhat-ethers/types" {
  ...
  getContractFactory(name: 'ExecSwap', signerOrOptions?: ethers.Signer | FactoryOptions): Promise<Contracts.ExecSwap__factory>
getContractFactory(name: 'TestToken', signerOrOptions?: ethers.Signer | FactoryOptions): Promise<Contracts.TestToken__factory>

  getContractAt(name: 'ExecSwap', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.ExecSwap>
getContractAt(name: 'TestToken', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.TestToken>

  deployContract(name: 'ExecSwap', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.ExecSwap>
deployContract(name: 'TestToken', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.TestToken>

  deployContract(name: 'ExecSwap', args: any[], signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.ExecSwap>
